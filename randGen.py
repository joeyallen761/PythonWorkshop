...
with open('data.csv', 'wb') as csvfile:
    ...
    for i in range(100):
        gpa = round(3+1*random.random(),2)
        SAT = round(1100+500*random.random(),0)
        asvab = int(round(80+19*random.random(),0))
        name = names[int(random.random()*len(names))]+" "+lastnames[int(random.random()*len(lastnames))]
        writer.writerow([name,gpa,SAT,asvab])
